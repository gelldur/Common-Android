package com.dexode.view;

/**
 * Created by Dawid Drozd aka Gelldur on 1/12/16.
 * Source code from gist: https://gist.github.com/ademar111190/7d31dab71502e6a85b8a
 */
...
public class SearchViewFormatter {
	...
	protected LayoutTransition mTransition;
	...
	public SearchViewFormatter setLayoutAnimation(LayoutTransition transition) {
	...
	public void format(SearchView searchView) {
		...
		if (mSearchIconResource != 0) {
			...
			if (mSearchIconInside) {
				...
				hintBuilder.setSpan(new ImageSpan(searchIconDrawable), 1, 2, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
		...
		if (mTransition != null) {
			final int searchBarId = getIdentifier("search_bar");

			LinearLayout searchBar = (LinearLayout) searchView.findViewById(searchBarId);
			searchBar.setLayoutTransition(mTransition);
		}
	}
